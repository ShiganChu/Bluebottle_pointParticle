...
*/
    ...
    coeffs<<<numBlocks_x, dimBlocks_x>>>(_dom[dev], _flag_u[dev], _flag_v[dev],_flag_w[dev], _A_p->values.pitch, thrust::raw_pointer_cast(&_A_p->values.values[0]));
...
/*
printf("_pp %g %g \n",*_pp);
printf("_ptr_p + dom[dev].Gcc._s3 %g %g \n",_ptr_p , dom[dev].Gcc._s3);
*/
