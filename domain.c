...
void domain_read_input(void)
{
  ...
  if(strcmp(buf, "WEST") == 0)
    ...
    fprintf(stderr, "flow.config read error.\n");
    fprintf(stderr, "out_plane not found.\n");
    exit(EXIT_FAILURE);
  }
  fret = fscanf(infile, "\n");
...
/*
    fprintf(rest, "%d ", points[i].cage.cx);
    fprintf(rest, "%d ", points[i].cage.cy);
    fprintf(rest, "%d ", points[i].cage.cz);
    fprintf(rest, "%d ", points[i].cage.is);
    fprintf(rest, "%d ", points[i].cage.ibs);
    fprintf(rest, "%d ", points[i].cage.ie);
    fprintf(rest, "%d ", points[i].cage.ibe);
    fprintf(rest, "%d ", points[i].cage.in);
    fprintf(rest, "%d ", points[i].cage.js);
    fprintf(rest, "%d ", points[i].cage.jbs);
    fprintf(rest, "%d ", points[i].cage.je);
    fprintf(rest, "%d ", points[i].cage.jbe);
    fprintf(rest, "%d ", points[i].cage.jn);
    fprintf(rest, "%d ", points[i].cage.ks);
    fprintf(rest, "%d ", points[i].cage.kbs);
    fprintf(rest, "%d ", points[i].cage.ke);
    fprintf(rest, "%d ", points[i].cage.kbe);
    fprintf(rest, "%d ", points[i].cage.kn);
 */
 }
  fprintf(rest, "\n");
...
*/
 ...
 /*
    fret = fscanf(infile, "%d ", &points[i].cage.cx);
    fret = fscanf(infile, "%d ", &points[i].cage.cy);
    fret = fscanf(infile, "%d ", &points[i].cage.cz);
    fret = fscanf(infile, "%d ", &points[i].cage.is);
    fret = fscanf(infile, "%d ", &points[i].cage.ibs);
    fret = fscanf(infile, "%d ", &points[i].cage.ie);
    fret = fscanf(infile, "%d ", &points[i].cage.ibe);
    fret = fscanf(infile, "%d ", &points[i].cage.in);
    fret = fscanf(infile, "%d ", &points[i].cage.js);
    fret = fscanf(infile, "%d ", &points[i].cage.jbs);
    fret = fscanf(infile, "%d ", &points[i].cage.je);
    fret = fscanf(infile, "%d ", &points[i].cage.jbe);
    fret = fscanf(infile, "%d ", &points[i].cage.jn);
    fret = fscanf(infile, "%d ", &points[i].cage.ks);
    fret = fscanf(infile, "%d ", &points[i].cage.kbs);
    fret = fscanf(infile, "%d ", &points[i].cage.ke);
    fret = fscanf(infile, "%d ", &points[i].cage.kbe);
    fret = fscanf(infile, "%d ", &points[i].cage.kn);
*/
#else
